...
public static class BuildTool
{
    ...
    public static void BuildApk()
    {
        ...
        var apk = Path.Combine(outDir, $"Timberline-{PlayerSettings.bundleVersion}.apk");
        ...
        PlayerSettings.productName = "Timberline";
        PlayerSettings.SetApplicationIdentifier(NamedBuildTarget.Android, "com.cr0sz.timberline");

        // Launcher icon, generated by dev/make_logo.py. Set here rather than by hand so
        // a re-run of the logo script plus a rebuild is enough to reskin the app.
        var icon = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/UI/Branding/icon-1024.png");
        if (icon != null)
        {
            PlayerSettings.SetIcons(NamedBuildTarget.Android,
                                    new[] { icon }, IconKind.Application);
        }
        else Debug.LogWarning("[BUILD] icon-1024.png not found under Assets/UI/Branding — shipping Unity's default icon.");
